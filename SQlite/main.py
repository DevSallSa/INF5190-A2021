...
# On commence par définir une instance de la classe Database
# pour pouvoir utiliser les méthodes
db = Database()
...
if __name__ == "__main__": 
    lire_db()
    ecrire_db()
    # Pour visualiser les changements ayant été faits sur la base de données :
    # db.get_all_artistes()
